...
{   
    ...
    confidence_bar->setVisible(false);
    confidence_label->setVisible(false);

    fps_acq_label->setVisible(false);
    lcd_fps_acq->setVisible(false);
    //    lcd_fps_acq->setVisible(false);
    learning_button->setVisible(false);
    exporting_button->setVisible(false);
    importing_button->setVisible(false);
    alternating_button->setVisible(false);
    stop_tracking_button->setVisible(false);
    background_reset_button->setVisible(false);
...
void BaseFrame::image_receivedCB(const sensor_msgs::CompressedImageConstPtr & msg)
{
...
//                cv_ptr = cv_bridge::toCvShare(msg, enc::MONO8);
        ...
        QImage image = QImage((const unsigned char*)(cv_ptr->image.data),cv_ptr->image.cols,cv_ptr->image.rows,QImage::Format_RGB888);
